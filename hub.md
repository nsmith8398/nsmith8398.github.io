...
* **Definition and Purpose:** Home Assistant is an open-source operating system that acts as the brain for a local smart home. The core documentation is a technical manual for setting up the server and integrating devices into it without needing cloud servers that are external.
